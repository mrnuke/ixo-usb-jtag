...
%description
%{name} firmware allows a Cypress FX2 EZ-USB microcontroller to act like a
...
install -m 0644 scripts/ixo-usb-jtag.rules \
	-D %{buildroot}/lib/udev/rules.d/69-ixo-usb-jtag.rules


%files
%doc README.md
%{_datadir}/%{name}/*.hex
/lib/udev/rules.d/69-ixo-usb-jtag.rules


%changelog
* Mon Mar  6 2017 mrnuke <mr.nuke.me@gmail.com>
- Initial RPM release
